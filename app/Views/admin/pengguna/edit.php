...
<form action="<?= base_url('admin/pengguna/update/' . $pengguna['pengguna_id']); ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field(); ?>
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="role">
            <option value="admin" <?= old('role', $pengguna['pengguna_role']) == 'admin' ? 'selected' : ''; ?>> Admin </option>
