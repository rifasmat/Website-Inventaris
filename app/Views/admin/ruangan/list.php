...
<div class="box-header">
    <span class="btn-group pull-right mr-5">
        <a href="<?= base_url('admin/ruangan/create'); ?>" class="btn btn-secondary" target="_blank">
            ...
            <div class="col-lg-4 col-xs-6">
                <div class="small-box bg-secondary bg-gradient">
                    ...
                    <div class="small-box-footer">
                        ...
                        <a href="<?= base_url('admin/ruangan/konfirmasi/' . $ruangan['ruangan_id']) ?>" class="btn btn-secondary btn-sm text-light">
                            <i class="fa fa-trash"></i> Hapus Ruangan
                        </a>
                    </div>
                </div>
            </div>
